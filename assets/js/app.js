        ...
        searchTimeout = setTimeout(() =>{
            ...
            for(const {name, lat, lon, country, state} of locations){
                ...
                searchItem.innerHTML = `
                        <span class="m-icon"><i class="ri-map-pin-line"></i></span>
...
export const updateWeather = function (lat, lon){
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather){
                        ...
                        <div class="wrapper">
                            ...
                            <ul class="card-list">
                                ...
                                <li class="card-item">
                                    ...
                                    <p class="lable-1">PM<sub>2.5</sub></p>
                                </li>

                                <li class="card-item">
                                    <p class="title-1">${so2.toPrecision(3)}</p>

                                    <p class="lable-1">SO<sub>2</sub></p>
                                </li>

                                <li class="card-item">
                                    <p class="title-1">${no2.toPrecision(3)}</p>

                                    <p class="lable-1">NO<sub>2</sub></p>
                                </li>

                                <li class="card-item">
                                    <p class="title-1">${o3.toPrecision(3)}</p>

                                    <p class="lable-1">O<sub>3</sub></p>
                                </li>
                            </ul>
                        </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast){
            ...
            for (const [index, data] of forecastList.entries()){
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="" class="weather-icon"  style="transform: rotate(${windDirection - 180}deg)" title="">
             ...
             */
            forecastSection.innerHTML = `
                <h2 class="title-3" id="forecast-label">5 Days Forecast</h2>
